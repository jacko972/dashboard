 ...
 * @final
 */
export class ResourceCardBlerkoMenuItemController {
  /**
 ...
 */
export const resourceCardBlerkoMenuItemComponent = {
  templateUrl: 'common/components/resourcecard/resourcecardblerkomenuitem.html',
  bindings: {
    'resourceKindName': '@',
  },
  ...
  controller: ResourceCardBlerkoMenuItemController,
};

const i18n = {
  /** @export @desc Label for YAML edit menu item. */
  MSG_YAML_BLERKO_MENU_LABEL: goog.getMsg('Blerko'),
};
